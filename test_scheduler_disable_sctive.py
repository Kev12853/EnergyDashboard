"""
test_scheduler_disable_active.py

Verify that disabling an active schedule requests restoration
...
#
# Disable the schedule while still inside the window.
#
...
#
# Execute while still inside the original schedule window.
#
